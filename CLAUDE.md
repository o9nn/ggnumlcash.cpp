...
- `examples/financial-sim/membrane-reconciler.h` (header-only) + `test-membrane-reconciler` (15 tests)
...
- `to_plingua()` emits the same system for the `ReZorg/plingua` simulator
